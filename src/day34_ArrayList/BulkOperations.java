...
public class BulkOperations {
    ...
    public static void main(String[] args) {
        ...
        // verify if 10, 30, 50 & 60 all are contained in the list
        boolean r3 =    list.containsAll(   Arrays.asList( 10, 30, 50, 60 )   );//Arrays.asList(ArrayValue): returns the array value as collection type
        ...
        */
        ...
        employees2.retainAll( Arrays.asList("Ahmed") ); //	retainAll( CollectionType ): removes all the elements that are not matching. removeAllExcept

        System.out.println(employees2); // Ahmed 'e match olmayan butun isimleri kaldirir
