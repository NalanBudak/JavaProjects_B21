...
public class SimpleLambdaExpressions {
    ...
    public static void main(String[] args) {
        ...
        numbers2.removeIf( element  ->  element < 7 ); // eger elementler 7' den kucukse , kucuk olanlari kaldiracak
        ...
        scores.removeIf( p  ->   p%3 == 0 || p%5==0 );  // eger elemntler 3 ve 5 e bolunuyorsa bu elemntleri kaldiracak.  p elementleri temsil ediyor. p de olabilir baska harf yada kelimede olabilir.
        ...
        employees2.removeIf( p -> p.startsWith("A") && !p.equals("Ahmed") ); // eger elementler A'ile basliyorsa ve Ahmed' e esit degilse kaldiracak esit olmayanlari. yani, Adil ve afrooz kaldirilacak
