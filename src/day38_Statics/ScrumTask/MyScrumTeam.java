...
public class MyScrumTeam {
    ...
    public static void main(String[] args) {
        ...
        Developer developer1 = new Developer(); // bu step , for creating object
        ...
        for(Developer each   : scrum1.developersTeam ){ // developers 'lari print edecek
            System.out.println(each);
        }

        for(Tester each  : scrum1.testersTeam ){
            System.out.println(each); // tester'leri print edecek
        }
