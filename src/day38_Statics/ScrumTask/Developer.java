...
public class Developer {
   ...
   public void setInfo(String name, String ID, String jobTitle, String companyName, double salary, char gender) {  // command + n  yapinca kisa yolu verir.
        this.name = name;
        this.ID = ID;
    ...
    public String toString() {       // command + n     (shortcut)
        return "Developer{" +
                "name='" + name + '\'' +
                ", ID='" + ID + '\'' +
                ", jobTitle='" + jobTitle + '\'' +
