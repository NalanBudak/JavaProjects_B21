...
public class Circle {
    ...
    public String toString() {  //toString methods: gets executed automatically when you pass the object in print statement //instance return method, String yapar.//  No argument
