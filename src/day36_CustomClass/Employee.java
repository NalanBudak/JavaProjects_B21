...
public class Employee {
    ...
    public String name, jobTitle, ID, companyName ; // instance variable
    ...
    public void setInfo(String name, char gender, String jobTitle, String companyName, double salary, String ID, LocalDate hireDate ){
        ...
        this.gender = gender;  // this. ===>refers to object instance// this 'i instance ile local instance name ayni ise kullaniyoruz. degilse kullanmiyoruz
