...
import day37_CustomClass.Employee;  // day37 employee class 'i cagirdik

public class HumanResource {

    public static Employee employee1, employee2, employee3, employee4, employee5;

  static  {  // burada main method kullanamazdik .kullansaydik null verecekti. cunku,main method can not run for other class.



        employee1 = new Employee(); // yeni object create etmek icin new key word u kullaniyoruz
